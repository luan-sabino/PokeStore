...
var produtos = [
    { nome: "Araquanid", categoria: "Agua", preco: 75.20, imgpath: "src/752Araquanid.png"},
    { nome: "Barraskewda", categoria: "Agua", preco: 84.70, imgpath: "src/847Barraskewda.png"},
    { nome: "Cramorant", categoria: "Agua", preco: 84.50, imgpath: "src/845Cramorant.png"},
    { nome: "Dracovish", categoria: "Agua", preco: 88.20, imgpath: "src/882Dracovish.png"},
    { nome: "Empoleon", categoria: "Agua", preco: 39.50, imgpath: "src/395Empoleon.png"},
    { nome: "Blaziken", categoria: "Fogo", preco: 25.70, imgpath: "src/257Blaziken.png"},
    { nome: "Cyndaquil", categoria: "Fogo", preco: 15.50, imgpath: "src/155Cyndaquil.png"},
    { nome: "Flareon", categoria: "Fogo", preco: 13.60, imgpath: "src/136Flareon.png"},
    { nome: "Growlithe", categoria: "Fogo", preco: 5.80, imgpath: "src/058Growlithe.png"},
    { nome: "Houndoom", categoria: "Fogo", preco: 22.90, imgpath: "src/229Houndoom.png"},
    { nome: "Bayleef", categoria: "Grama", preco: 15.30, imgpath: "src/153Bayleef.png"},
    { nome: "Celebi", categoria: "Grama", preco: 25.10, imgpath: "src/251Celebi.png"},
    { nome: "Gogoat", categoria: "Grama", preco: 67.30, imgpath: "src/673Gogoat.png"},
    { nome: "Leafeon", categoria: "Grama", preco: 47.00, imgpath: "src/470Leafeon.png"},
    { nome: "Maractus", categoria: "Grama", preco: 55.60, imgpath: "src/556Maractus.png"},
    { nome: "Armaldo", categoria: "Inseto", preco: 34.80, imgpath: "src/348Armaldo.png"},
    { nome: "Beautifly", categoria: "Inseto", preco: 26.70, imgpath: "src/267Beautifly.png"},
    { nome: "Charjabug", categoria: "Inseto", preco: 73.70, imgpath: "src/737Charjabug.png"},
    { nome: "Dottler", categoria: "Inseto", preco: 82.50, imgpath: "src/825Dottler.png"},
    { nome: "Escavalier", categoria: "Inseto", preco: 58.90, imgpath: "src/589Escavalier.png"}
]
